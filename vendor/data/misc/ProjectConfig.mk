...
#prize modify by zhuzhengjiang for camera 20190929 start
CUSTOM_HAL_IMGSENSOR=s5kgm1st_mipi_raw s5kgm1sp_mipi_raw ov168854cell_mipi_raw ov16a1q_mipi_raw s5k4h7yx_mipi_raw ov2680_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR=s5kgm1st_mipi_raw s5kgm1sp_mipi_raw s5k4h7yx_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR=ov168854cell_mipi_raw ov16a1q_mipi_raw
CUSTOM_KERNEL_IMGSENSOR=s5kgm1st_mipi_raw s5kgm1sp_mipi_raw ov168854cell_mipi_raw ov16a1q_mipi_raw s5k4h7yx_mipi_raw ov2680_mipi_raw 
CUSTOM_KERNEL_MAIN_IMGSENSOR=s5kgm1st_mipi_raw s5kgm1sp_mipi_raw s5k4h7yx_mipi_raw
CUSTOM_KERNEL_SUB_IMGSENSOR=ov168854cell_mipi_raw ov16a1q_mipi_raw
MTK_CAM_MAX_NUMBER_OF_CAMERA = 4
CUSTOM_HAL_MAIN2_IMGSENSOR =ov2680_mipi_raw
...
# prize modify by mahuiyin 20190415-start
CUSTOM_KERNEL_DEVICE_ORIENTATION = no
# prize modify by mahuiyin 20190415-end
...
CUSTOM_KERNEL_MAIN2_IMGSENSOR = ov2680_mipi_raw
...
#prize modify by anhengxuan for synaptics firmware  20210824 begin
PRIZE_TOUCH_SYNAPTICS_TCM=yes
#prize modify by anhengxuan for synaptics firmware  20210824 end
CUSTOM_MODEM=k6307f2gm-LWTG_R3_6771-4M-G4W1258F12357820T3840_V0.2_androidR
...
#prize modified by anhengxuan,no support EIS,disenable EIS-20210818-begin
MTK_CAM_EIS_SUPPORT = no
#prize modified by anhengxuan,no support EIS,disenable EIS-20210818-end
...
MTK_UCE_SUPPORT = no
#prize modified by anhengxuan,low light splash 20210817-begin
MTK_ULTRA_DIMMING_SUPPORT = yes
#prize modified by anhengxuan,low light splash 20210817-end
...
#prize penggy modify for sensor CTS  20190316-begin
...
#prize penggy modify for sensor CTS  20190316-end
...
MTK_PERF_PLUS = no
MTK_OPEN_PACKAGE = no
#prize modfiy by wuliang 20201104 QR OTA begin
MTK_AB_OTA_UPDATER = no
#prize modfiy by wuliang 20201104 QR OTA end
...
PRIZE_SW_VERSION=k6307f2gm_ss.$(PRIZE_FLASH_CODE).$(shell date +%m%d_%H%M).V1.0
# UFS
MTK_UFS_OTP = yes
MTK_UFS_SUPPORT = yes
# Charge
...
PRIZE_AUDIO_AWINIC_MEC_SKT3 = yes

#硬件计步导致CTS fail，解决问题用此宏控制
